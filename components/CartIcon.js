...
const CartIcon = () => {
    ...
    return (
        <View className='absolute bottom-5 w-full z-10'>
            <TouchableOpacity
                className='mx-5 bg-[#498fdd] p-4 rounded-lg flex-row items-center space-x-1'
                onPress={() => navigation.navigate("Cart")}
            >
                <Text className='text-white font-extrabold text-lg bg-[#1863b8] py-1 px-2'>{items.length}</Text>
